...
public class ClauseTest extends SimpleNLG4TestBase {
	...
	public void testForm() {
		...
		CoordinatedPhraseElement subject = phraseFactory.createCoordinatedPhrase(
				this.phraseFactory.createNounPhrase("Jane"), this.phraseFactory //$NON-NLS-1$
						.createNounPhrase("Andrew")); //$NON-NLS-1$
	...
	public void testComplexSentence1() {
		...
		CoordinatedPhraseElement coord = phraseFactory.createCoordinatedPhrase(this.s3,
				s5);
	...
	public void testComplexSentence3() {
		...
		CoordinatedPhraseElement coord2 = phraseFactory.createCoordinatedPhrase(this.s1,
				this.s3);
	...
	public void testPassive() {
		...
		PhraseElement _s3 = this.phraseFactory.createClause(
				phraseFactory.createCoordinatedPhrase("my dog", "your cat"), "chase", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				"George"); //$NON-NLS-1$
		...
		_s3 = this.phraseFactory.createClause(phraseFactory.createCoordinatedPhrase(
