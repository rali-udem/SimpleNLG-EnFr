...
public class ExternalTest extends SimpleNLG4TestBase {
	...
	public void testDwight() {
		...
		NPPhraseSpec noun3 = this.phraseFactory
				.createNounPhrase("changed copy"); //$NON-NLS-1$
		noun3.setSpecifier("one"); //$NON-NLS-1$
		noun3.addComplement(prep1);

		CoordinatedPhraseElement coordNoun1 = phraseFactory.createCoordinatedPhrase(
				noun1, noun2);
		...
		CoordinatedPhraseElement coord1 = phraseFactory.createCoordinatedPhrase(noun2,
				noun3);
	...
	public void testData2Text() {
		...
		Assert.assertEquals("There are data dropouts.",
				realiser.realiseSentence(sentence2));
